...
namespace IgescConecta.API.Features.ProjectTypes.CreateProjectType
{
    ...
    public class CreateProjectTypeEndpoint : ControllerBase
    {
        ...
        public CreateProjectTypeEndpoint(IMediator mediator) => _mediator = mediator;
        ...
        {
            var result = await _mediator.Send(new CreateProjectTypeCommand { Name = request.Name });
    ...
    public class CreateProjectTypeResponse
    {
        ...
        public CreateProjectTypeResponse(int id) => ProjectTypeId = id;
    }
}
